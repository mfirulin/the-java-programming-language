public class LinkedList implements Cloneable {
    ...
    public Object findElem(Object obj) throws ObjectNotFoundException {
        for(Node l = list; l != null; l = l.next) {
            if(l.obj == obj) {
                return obj;
            }
    ...
    public static void main(String[] args) {
        ...
        try {
            Vehicle vh = new Vehicle("Alien");
            list.findElem(vh);
        }
        catch (ObjectNotFoundException e) {
            System.out.println("Object is not found: " + e);
        }
    }
}
